...
const SectionCard = (props) => {
    return (
        <div autoFocus={props.autoFocus} key={props.section.id} className="center mw5 mw6-ns br3 hidden ba b--black-10 SectionCard" tabIndex="0" onKeyDown={(event) => props.onDown(event, props.section)}
