...
const SectionCard = (props) => {
    return (
        <div  
            key={props.section.id} className="center mw5 mw6-ns br3 hidden ba b--black-10 SectionCard" 
        ...
        > 
            ...
            <div className="pa3 bt">
                ...
                <a onClick={ () => props.onVote(props.section.id)} className="link dim" href="#0"><i className="fas fa-thumbs-up"  />{props.section.votes}</a>
